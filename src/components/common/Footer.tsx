            ...
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-5 gap-8">
                <div className="md:col-span-1">
                    ...
                    <div className="flex space-x-4 mt-6">
                        {/* Social Media Icons */}
                        <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-yellow-500 transition-colors">
                        ...
                        <a href="https://t.me" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-yellow-500 transition-colors">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li>
                            <Link to="/about" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">About Mongol CEX</Link>
                        </li>
                        <li>
                            <Link to="/careers" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">Careers</Link>
                        </li>
                        <li>
                            <Link to="/legal" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">Legal & Privacy</Link>
                        </li>
                        <li>
                            <Link to="/blog" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">Blog</Link>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="space-y-2">
                        <li>
                            <Link to="/trade" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">Spot Trading</Link>
                        </li>
                        <li>
                            <Link to="/quick-swap" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">Quick Swap</Link>
                        </li>
                        <li>
                            <Link to="/wallet" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">My Assets</Link>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="space-y-2">
                        <li>
                            <Link to="/features-overview" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">Features Overview</Link>
                        </li>
                        <li>
                            <Link to="/security" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">Security</Link>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="space-y-2">
                        <li>
                            <p className="text-gray-400 text-sm">Email: support@mongolcex.com</p>
                        </li>
                        <li>
                            <p className="text-gray-400 text-sm">Phone: +976 7711 7711</p>
                        </li>
                        <li>
                            <Link to="/support" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">24/7 Chat Support</Link>
                        </li>
                        <li>
                            <Link to="/faq" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">FAQ</Link>
                        </li>
                        <li>
                            <Link to="/contact" className="text-gray-400 hover:text-yellow-500 text-sm transition-colors">Contact Us</Link>
                        </li>
                    </ul>
                </div>
            </div>
