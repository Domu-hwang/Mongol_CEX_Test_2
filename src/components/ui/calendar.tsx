    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                hidden: "invisible",
                dropdown: "rdp-dropdown relative appearance-none bg-background border border-border rounded-md px-2 py-1 text-sm cursor-pointer hover:bg-accent transition-colors",
