...
export const useAuth = () => {
    const [user, setUser] = useState<any>(() => {
        ...
        try {
            ...
            // For testing, ensure isKycCompleted is false by default unless explicitly true
            return parsedUser ? { ...parsedUser, isKycCompleted: parsedUser.isKycCompleted === true } : null;
        } catch (error) {
