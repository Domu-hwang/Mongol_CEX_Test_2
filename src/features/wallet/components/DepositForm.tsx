...
const DepositForm: React.FC<DepositFormProps> = ({ isLoading = false }) => {
    ...
    const {
        ...
        networks,
        networkPolicy,
        // currencyInfo, // currencyInfo is not used
        setCurrency,
        setNetwork,
    ...
    useEffect(() => {
        if (currency && network) {
            setCurrentStep(2); // Move to "Deposit Address" step
        } else if (currency) {
    ...
    const steps = [
        ...
        { label: 'Deposit Address', description: 'Send funds to the generated address' },
    ];
                                    ...
                                    <AccordionContent>
                                        <div className="space-y-3 text-sm">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-medium">{networkPolicy.estimatedTime}</span>
                                            </div>
