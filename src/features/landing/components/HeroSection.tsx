...
const HeroSection: React.FC = () => {
    return (
        <section className="relative min-h-[650px] flex items-center justify-center overflow-hidden bg-gradient-to-b from-background via-muted to-background">
            ...
            <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
                {/* Beta Status Badge */}
                <Badge className="mb-6 bg-brand/10 text-yellow-600 dark:text-yellow-400 border-brand/50 px-4 py-1">
                    Beta Test Now Live
                </Badge>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-foreground">
                    ...
                    <br />
                    <span className="text-yellow-500">Digital Finance in Mongolia</span>
                </h1>
